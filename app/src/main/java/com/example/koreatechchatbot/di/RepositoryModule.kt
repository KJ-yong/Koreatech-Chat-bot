...
import com.example.data.repository.ChatRoomRepositoryImpl
...
object RepositoryModule {
    ...
    fun provideChatRoomRepository(
        chatRoomLocalDataSource: ChatRoomLocalDataSource
    ): ChatRoomRepository = ChatRoomRepositoryImpl(chatRoomLocalDataSource)
}